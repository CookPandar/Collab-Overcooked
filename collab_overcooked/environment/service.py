...
if __name__ == '__main__':
    ...
    python main.py --layout counter_circuit --p0 LLMPair --p1 Greedy --llm_model gpt-3.2-turbo-0301 --prompt_level l2-ap --retrival_method recent_k --K 1
    ...
    python main.py --layout new_env --p0 LLMPair --p1 LLMPair --horizon 400 -pl l2-ap --mode exp --llm_model llama3:70b-instruct-fp16
